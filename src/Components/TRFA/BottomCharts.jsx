...
const VoltageCurrent = ({ data }) => {
  ...
  const voltageChartData = {
    ...
    datasets: [
      {
        label: "Line Voltage",
        data: data["resampled data"].map((item) => item.ln_voltage),
        fill: false,
    ...
    datasets: [
      {
        ...
        data: data["resampled data"].map((item) => item.average_current),
        fill: false,
      ...
      },
      {
        ...
        data: data["resampled data"].map((item) => item.phase_1_current),
        fill: false,
      ...
      },
      {
        ...
        data: data["resampled data"].map((item) => item.phase_2_current),
        fill: false,
      ...
      },
      {
        ...
        data: data["resampled data"].map((item) => item.phase_3_current),
        fill: false,
        backgroundColor: "rgba(75, 192, 192, 0.2)",
        borderColor: "rgba(75, 192, 192, 1)",
        borderWidth: 1,
